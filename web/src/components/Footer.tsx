  ...
  return (
    <footer className="flex py-6 bg-slate-800">
      <div className="container text-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex text-slate-300 gap-6">
          <a href="https://github.com/MisterKirill/blaze" target="_blank" className="hover:text-slate-400">
          ...
          <a href="https://discord.gg/sevHE5GXT2" target="_blank" className="hover:text-slate-400">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
